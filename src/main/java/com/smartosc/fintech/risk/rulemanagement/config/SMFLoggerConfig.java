...
import com.smartosc.fintech.risk.rulemanagement.common.util.SMFLogger;
...
public class SMFLoggerConfig {
    ...
    @Before("within(com.smartosc.fintech.risk.rulemanagement..*) "
            + "&& @annotation(com.smartosc.fintech.risk.rulemanagement.common.util.SMFLogger)")
    ...
    @AfterReturning("within(com.smartosc.fintech.risk.rulemanagement..*)"
            + " && @annotation(com.smartosc.fintech.risk.rulemanagement.common.util.SMFLogger)")
    ...
    @AfterThrowing(value = "within(com.smartosc.fintech.risk.rulemanagement..*) "
            + "&& @annotation(com.smartosc.fintech.risk.rulemanagement.common.util.SMFLogger)", throwing = "e")
